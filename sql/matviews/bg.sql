...
DROP MATERIALIZED VIEW IF EXISTS mp_bg CASCADE;
CREATE MATERIALIZED VIEW mp_bg as
...
DROP MATERIALIZED VIEW IF EXISTS mp_bg_art CASCADE;
CREATE MATERIALIZED VIEW mp_bg_art AS
with stg_spo2 as
(
